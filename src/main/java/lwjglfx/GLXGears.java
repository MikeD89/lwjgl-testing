...
import static lwjglfx.IOUtil.ioResourceToByteBuffer;
...
public class GLXGears {
    ...
    public GLXGears() {
        ...
        try {
            ByteBuffer vs = ioResourceToByteBuffer("gears.vert", 4096);
            ByteBuffer fs = ioResourceToByteBuffer("gears.frag", 4096);
